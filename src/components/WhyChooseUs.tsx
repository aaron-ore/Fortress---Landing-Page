...
const reasons = [
  {
    icon: <Award className="h-8 w-8 text-customPurple" />,
  ...
  {
    icon: <Heart className="h-8 w-8 text-customPurple" />,
  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-br from-black to-gray-950 text-white">
      <div className="container mx-auto text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold mb-4">Why Choose Fortress Inventory?</h2>

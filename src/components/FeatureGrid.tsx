    ...
    <section className="py-20 px-6 bg-gradient-to-br from-gray-950 to-black text-white">
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          <Card key={index} className="bg-[#1F3333] backdrop-blur-xl p-6 rounded-xl shadow-lg shadow-white-glow hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:-translate-y-2">

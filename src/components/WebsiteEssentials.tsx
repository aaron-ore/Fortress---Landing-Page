  ...
  return (
    <section className="py-20 px-6 bg-background text-foreground">
      <div className="container mx-auto text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-primary">What Every Modern Website Needs</h2>
      ...
      <div ref={ref} className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {websiteEssentials.map((item, index) => (
          <Card 
            key={index} 
            className={cn(
              "bg-card/10 backdrop-blur-xl p-6 rounded-xl shadow-lg shadow-white-glow card-3d-hover", // Added card-3d-hover

      ...
      <main className="pt-32 pb-20 px-6 bg-transparent text-foreground">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none text-muted-foreground space-y-6"> {/* Updated text color */}
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">1. Definitions</h2>
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">2. Subscription and Access Grant</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">3. Fees and Payment Terms</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">4. Customer Data Ownership and Use</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">5. Restrictions and Acceptable Use Policy</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">6. Intellectual Property Rights</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">7. Term and Termination</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">8. Warranties and Disclaimer</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">9. Limitation of Liability</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">10. Indemnification</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">11. General Provisions</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-3xl font-bold text-primary mt-10 mb-4">12. Contact Information</h2>
            <p>

    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-32 pb-20 px-6 bg-gradient-to-br from-gray-950 to-black text-white">
        <div className="container mx-auto max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-8 text-center drop-shadow-md text-customPurple">
          ...
          <div className="prose prose-invert max-w-none text-gray-300 space-y-6">
            ...
            <h2 className="text-3xl font-bold text-customPurple mt-10 mb-4">Built on a Better Foundation</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-customPurple mt-10 mb-4">The Result: Your Inventory, Under Control</h2>
            <p>
            ...
            <p className="text-xl font-semibold text-customPurple mt-8 mb-4">
            ...
            <p className="text-3xl font-extrabold text-customPurple">
